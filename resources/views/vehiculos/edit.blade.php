            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                    <div class="card shadow-sm">
                        ...
                        <form method="POST" action="{{ route('vehiculos.update', $vehiculo->id) }}" id="vehiculoForm"
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('tipo_vehiculo_id') is-invalid @enderror"
                                                ...
                                                <option value="{{ $tipo_vehiculo->id }}"
                                                    {{ old('tipo_vehiculo_id', $vehiculo->tipo_vehiculo_id) == $tipo_vehiculo->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="placa" id="placa" placeholder="Ej: ABC-123" autocomplete="off"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="modelo" placeholder="Ej: Corolla, Civic, Spark" autocomplete="off"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('año') is-invalid @enderror"
                                                name="año" id="año" placeholder="Ej: 2023" autocomplete="off"
                                                value="{{ old('año', $vehiculo->año) }}" min="1900"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('color') is-invalid @enderror"
                                                name="color" id="colorText" placeholder="Ej: Rojo, #DC3545"
                                                autocomplete="off" value="{{ old('color', $vehiculo->color) }}"
                                                required>
                                            <small class="form-text text-muted">Ingrese nombre o código
                                                hexadecimal</small>
                                            @error('color')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                name="kilometraje" id="kilometraje" placeholder="Ej: 10000"
                                                autocomplete="off"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <img src="{{ asset($vehiculo->imagen) }}" alt="Imagen actual"
                                                    class="img-fluid"
                                                    style="max-width: 300px; height: auto; border: 1px solid #ddd; border-radius: 5px;">
                                                <p class="text-muted mt-2"><small>Seleccione una nueva imagen solo si
                                                        desea cambiar la actual</small></p>
                                            </div>
                                            @endif
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="imagen">Seleccionar nueva
                                                    imagen...</label>
                                            </div>
                                            <small class="form-text text-muted">Formatos permitidos: JPG, JPEG, PNG,
                                                GIF. Tamaño máximo: 10MB</small>
                                            @error('imagen')
                                ...
                                <input type="hidden" name="estado"
                                    value="{{ old('estado', $vehiculo->estado ? 1 : 0) }}">
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <div class="alert alert-info mb-0">
                                            ...
                                            <strong>Nota:</strong> Los campos marcados con <span
