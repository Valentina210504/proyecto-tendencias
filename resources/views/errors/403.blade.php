...
<head>
    ...
    * {
    ...
    .security-particle {
        ...
        border-radius: 50%;
        animation: securityFloat 8s infinite ease-in-out;
        pointer-events: none;
    }
    ...
    .error-code {
        ...
        text-shadow: 0 5px 20px rgba(255, 255, 255, 0.2);
...
<body>
    <div class="flex flex-col items-center justify-center w-screen h-screen gap-12 py-8 ">
        ...
        <div class="text-content flex flex-col items-center gap-6 max-w-2xl">

            <h2 class="text-3xl md:text-4xl font-semibold text-center text-white">
                No Estás Autorizado
            </h2>
            <p class="text-lg md:text-xl text-center text-white opacity-90 px-4">
                Intentaste acceder a una página para la cual no tienes autorización previa.
            </p>
            <!-- Botón de regreso -->
            <a href="/"
                class="btn-home mt-4 px-8 py-4 bg-white bg-opacity-20 backdrop-blur-lg text-white font-semibold text-base rounded-full border-2 border-white border-opacity-30 hover:bg-opacity-30 transition-all duration-300">
